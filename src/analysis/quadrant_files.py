...
QUARTERS: dict[str, list[str]] = {
    "Q1": [  # Classic narratives × Symmetric inference
        ...
        "test_results/symmetric_inference/blue_eyed_islanders/closed_inference_blue_eyed_islanders_claude_opus_4.6_post_process.csv",
        ...
        "test_results/symmetric_inference/muddy_children/muddy_children_puzzles_dataset_first_deduction_claude_opus_4.6_post_process.csv",
        ...
        "test_results/symmetric_inference/wise_men/closed_inference_wise_men_claude_opus_4.6_post_process.csv",
    ],
    "Q2": [  # Classic narratives × Asymmetric inference
        ...
        "test_results/asymmetric_inference/blue_eyed_islanders/blue_eyed_islanders_additional_analysis_claude_opus_4.6_post_process.csv",
        ...
        "test_results/asymmetric_inference/muddy_children/muddy_children_additional_analysis_claude_opus_4.6_post_process.csv",
        ...
        "test_results/asymmetric_inference/wise_men/wise_men_additional_analysis_claude_opus_4.6_post_process.csv",
    ],
    "Q3": [  # New narratives × Symmetric inference
        ...
        "test_results/symmetric_inference/health_screening/closed_inference_health_screening_claude_opus_4.6_post_process.csv",
        ...
        "test_results/symmetric_inference/olympic_games/closed_inference_olympic_games_claude_opus_4.6_post_process.csv",
        ...
        "test_results/symmetric_inference/safety_inspection/closed_inference_safety_inspection_claude_opus_4.6_post_process.csv",
        ...
        "test_results/symmetric_inference/singing_contest/closed_inference_singing_contest_claude_opus_4.6_post_process.csv",
    ],
    "Q4": [  # New narratives × Asymmetric inference
        ...
        "test_results/asymmetric_inference/health_screening/health_screening_additional_analysis_claude_opus_4.6_post_process.csv",
        ...
        "test_results/asymmetric_inference/olympic_games/olympic_games_additional_analysis_claude_opus_4.6_post_process.csv",
        ...
        "test_results/asymmetric_inference/safety_inspection/safety_inspection_additional_analysis_claude_opus_4.6_post_process.csv",
        ...
        "test_results/asymmetric_inference/singing_contest/singing_contest_additional_analysis_claude_opus_4.6_post_process.csv",
    ],
}
